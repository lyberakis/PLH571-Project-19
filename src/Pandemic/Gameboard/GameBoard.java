...
public class GameBoard implements Cloneable {
	...
	public void infectCityPhase(int infectionRate) {
		...
		while (i < infectionRate) {
			...
			// infectPile.remove(0);
			// System.out.println("---");
			// System.out.println("Won't place a cube to "+cityToInfect.getName() +"because
			// of quarantine_specialist");
			// }
	...
	public void printStats() {
		System.out.println("Cubes: red: " + redCubes + " blue: " + blueCubes + " black: " + blackCubes + " yellow: "
				+ yellowCubes);
